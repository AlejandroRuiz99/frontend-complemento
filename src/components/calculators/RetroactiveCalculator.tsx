      ...
      {result && (
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h4 className="text-lg font-semibold text-success-400">Resultado del Cálculo Retroactivo</h4>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-dark-800/50 border border-legal-gold/20 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-medium text-white">Total de Atrasos</span>
              </div>
              <p className="text-3xl font-bold text-legal-gold">
            ...
            <div className="bg-dark-800/50 border border-legal-gold/20 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-medium text-white">Meses Calculados</span>
              </div>
              <p className="text-3xl font-bold text-legal-gold">
          ...
          {(result.period_1_amount || result.period_2_amount) && (
            <div className="space-y-3">
              <h5 className="text-md font-semibold text-white mb-3">Desglose por Períodos:</h5>
              
              {result.period_1_amount && (
                <div className="bg-dark-700/50 border border-legal-gold/20 rounded-lg p-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-white">Período 1</span>
                    <span className="text-lg font-bold text-legal-gold">
              ...
              {result.period_2_amount && (
                <div className="bg-dark-700/50 border border-legal-gold/20 rounded-lg p-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-white">Período 2</span>
                    <span className="text-lg font-bold text-legal-gold">
